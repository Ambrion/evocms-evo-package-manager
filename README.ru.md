...
Доступна автоматическая пост-инсталляция - миграции, публикация ресурсов; задел на то, что когда-то разработчик пакета сможет настраивать это в composer.json.
